...
#### Software features
- **Gut anatomogram** - a new human anatomogram for the large and small intestines has been added in this release and accompanies eligible experiments e.g. [Single-cell transcriptome analysis reveals differential nutrient absorption functions in human intestine](https://www.ebi.ac.uk/gxa/sc/experiments/E-GEOD-125970)
- **Inferred cell type marker gene heatmap** - for experiments where inferred cell type data is available you can now view marker genes based on the inferred cell type clusters e.g.
